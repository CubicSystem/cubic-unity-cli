...
Run `cubic-cli verify <path>` right after editing an existing `Assets/**/*.cs` file.

Run `cubic-cli verify --all` after creating or deleting `Assets/**/*.cs` files, or when the modified path under `Assets/` is ambiguous.
