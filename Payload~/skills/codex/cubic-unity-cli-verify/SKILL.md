...
Run `cubic-cli verify <path>` immediately after editing an existing `Assets/**/*.cs` file.

Run `cubic-cli verify --all` after creating or deleting `Assets/**/*.cs` files, or when the exact changed path under `Assets/` is unclear.
