...
{
    [CubicCliCommand(Group = "scene", Name = "scene", Description = "Inspect loaded scene structure.")]
    internal sealed class SceneCommand : ICubicCliCommandHandler, ICubicCliPreflightHandler
    {
