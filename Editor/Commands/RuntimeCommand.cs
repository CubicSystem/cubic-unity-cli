...
{
    [CubicCliCommand(Group = "runtime", Name = "runtime", Description = "Inspect or mutate runtime state while playing.")]
    internal sealed class RuntimeCommand : ICubicCliCommandHandler, ICubicCliPreflightHandler
    {
