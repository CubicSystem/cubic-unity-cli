...
{
    [CubicCliCommand(Group = "console", Name = "console", Description = "Read or clear Unity console entries.")]
    internal sealed class ConsoleCommand : ICubicCliCommandHandler
    {
