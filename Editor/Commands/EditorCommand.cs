...
{
    [CubicCliCommand(Group = "editor", Name = "editor", Description = "Control Unity editor state, play mode, menus, and refresh flows.")]
    internal sealed class EditorCommand : ICubicCliCommandHandler, ICubicCliPreflightHandler
    {
