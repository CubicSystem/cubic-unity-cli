...
{
    [CubicCliCommand(Group = "project", Name = "project", Description = "Project-wide asset maintenance commands.")]
    internal sealed class ProjectCommand : ICubicCliCommandHandler, ICubicCliPreflightHandler
    {
