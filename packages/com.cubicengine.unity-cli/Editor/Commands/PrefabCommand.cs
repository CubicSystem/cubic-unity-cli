...
{
    [CubicCliCommand(Group = "prefab", Name = "prefab", Description = "Instantiate and save prefab assets.")]
    internal sealed class PrefabCommand : ICubicCliCommandHandler, ICubicCliPreflightHandler
    {
