...
{
    [CubicCliCommand(Group = "verify", Name = "verify", Description = "Run Unity script verification workflow.")]
    internal sealed class VerifyCommand : ICubicCliCommandHandler
    {
