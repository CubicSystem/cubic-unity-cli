...
{
    [CubicCliCommand(Group = "object", Name = "object", Description = "Create and mutate scene objects and components.")]
    internal sealed class ObjectCommand : ICubicCliCommandHandler
    {
