...
{
    [CubicCliCommand(Group = "test", Name = "test", Description = "Run Unity Test Runner suites and read their status.")]
    internal sealed class TestCommand : ICubicCliCommandHandler
    {
